...
function Renderable(shader) {
    ...
    this.creationTime = 0; //Used to implement delete functionality
}
...
Renderable.prototype.getCreationTime = function () { return this.creationTime;};
Renderable.prototype.setCreationTime = function (time) { this.creationTime = time};
